...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_2gfs6aj', 'template_eccvd66', form.current, {
                publicKey: 'rRXlHPC3bstWyBqdW',
            })
            .then(
                e.tartget.reset()
            );
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__infor">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">0966497003</span>
                        ...
                        <div className="contact__card">
                            ...
                            <a href="https://m.me/testuser" className="contact__button">Write me
                                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div className="contact__content">
                    ...
                    <form ref={form} onSubmit={sendEmail} action="" className="contact__form">
                        <div className="contact__form-div">
                            <label htmlFor="" className="contact__form-tag">Name
                            </label>
                            <input type="text" name='name' className='contact__form-input' placeholder='Insert your name' />
                        </div>
                        <div className="contact__form-div">
                            <label htmlFor="" className="contact__form-tag">Mail
                            </label>
                            <input type="email" name='name' className='contact__form-input' placeholder='Insert your email' />
                        </div>
                        <div className="contact__form-div contact__form-area">
                            <label htmlFor="" className="contact__form-tag">Project
                            </label>
                    ...
                    <button className="button button--flex" onSubmit={sendEmail}>Send message
                        <svg
                            class="button__icon"
